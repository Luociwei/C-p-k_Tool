...
def cpk_plot(table_data,zmqMsg):
    try:
        ...
        if select_color_by >0 or select_color_by_right>0:  # color by choose
            ...
            draw_more_histogram(tb_data2,all_data,zmqItem,item_name,lsl, usl, mean, max_num, min_num, stdev, x1, y1, cpu, cpl, cpk, pic_path,set_bins,start_time_first,start_time_last,zoom_type='limit')
            ...
            pic_path = path +'/temp/'
            pic_path = pic_path + image_name
            draw_histogram(tb_data,item_name,lsl, usl, mean, max_num, min_num, stdev, x1, y1, cpu, cpl, cpk, pic_path,set_bins,start_time_first,start_time_last,zoom_type='limit')
